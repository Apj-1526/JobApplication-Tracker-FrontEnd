							...
							<div className="px-4 py-6 sm:px-8 sm:py-7">
								<form action="#" method="POST" onSubmit={handleSubmit}>
									<div className="space-y-5">
										...
										<div>
											<label htmlFor="role" className="text-base font-medium text-gray-900">Select Role</label>
											<select
												name="role"
												id="role"
												value={formData.role}
										...
										<div className="text-center">
											<p className="text-base text-gray-600">Already have an account? <a href="/login" title="" className="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Login here</a></p>
										</div>
									</div>
								</form>
							</div>
